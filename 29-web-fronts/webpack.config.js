            ...
            loaders: removeEmpty([                                          // [29]
                {
                    ...
                    exclude: pathResolve('src/common/fonts')                // [44]
                },
                {
                    test: /\.(woff|woff2|ttf|eot|svg|otf)(\?v=[a-z0-9]\.[a-z0-9]\.[a-z0-9])?$/,  // [42]
                    loader: 'file-loader?&name=fonts/[name].[ext]'                               // [43]
                },
                ifProd(
                    {
                        test: /\.(less|css)$/,                              // [18][37]
...
//
// [44] • Don't want to include svg in font under '/imgs/'.
//
// [43] • Load fonts with file-loader and output them under '/fonts/' folder.
//
// [42] • Match fonts file extension.
//
// [41] • Can leave off less extention when requiring a style file.
//
// [40] • Common styling setting and initialization
//
// [39] • 3rd party style library.
//
